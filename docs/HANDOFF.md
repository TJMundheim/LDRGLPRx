...
- Women's HRT product line still needs telemed partner prescribing. App: Xcode project generated (xcodegen at ~/.local/xcodegen); BLOCKED on TJ installing full Xcode + `sudo xcode-select -s /Applications/Xcode.app/Contents/Developer`; TJ opening Apple Developer account.
