...
The OTC supplement stack is exactly what the name says: over-the-counter. Available without a prescription. Curated to a specific standard described in Appendix B.
...
- **Appendices A–D:** The 10-question assessment, the stack reference, the eliminate-the-insulting-behavior checklist, the glossary.

The front of the book sells you the why. The back of the book runs the how. They are meant to be used together.
...
That was the sentence. That was the whole reason he had driven two hours to see me, after months of telling himself it was nothing. Losing words in meetings. The board meetings he had run a hundred times. The numbers he had recited from memory for two decades. The names of the regional managers he had hired himself. He was watching them slide, one at a time, behind a wall in his own head. He could feel the wall getting thicker. He had told no one. Not his wife. Not his partners. Not his primary care doctor — who, two months earlier, had run a full panel and told him he was the healthiest fifty-eight-year-old in the practice.
...
That moment was not nothing. That moment was real signal. Not a sentence — a signal. It does not mean you have Alzheimer's. It does not mean you are losing your mind. It means the underlying machinery — the gut barrier, the vascular endothelium, the sleep architecture, the hormonal milieu, the inflammatory tone — is starting to drift, and the brain is the first organ sensitive enough to tell you about it.
...
I am not going to do that. The fear is already in you. You bought the book. You opened it. You read this far. I do not need to manufacture more.
...
I stole the title. I won't pretend otherwise. Stephen Covey put *Begin with the End in Mind* on the page in 1989 as the second of his seven habits, and a generation of executives — me included — read it, underlined it, taped it to the inside of the briefcase, and used it to build companies, careers, marriages, retirement plans. It is one of the most useful sentences ever written about how to live a life on purpose.
...
Here is the passage I want you to read twice. It is the closest thing this program has to a thesis statement, and it appears verbatim on the Mind pillar page of My4MLife. Read it slowly.
...
Let me walk you through the four pillars in the order they actually deploy in your week. We will go deep on each one in its own chapter. For now I want you to leave this chapter with the shorthand burned in.
...
# Chapter 4 — Cognitive Healthspan: What We're Protecting

Before we walk down through the three pillars that do the work — Mitigate, Muscle, Motivate — I want you to stop here for a chapter and look at the destination. Really look at it. Not the way the wellness industry asks you to look at it, with soft-focus pictures of grandfathers on beaches. Look at it the way you'd look at a property line you're about to defend. What exactly are we protecting? What does it look like when we lose it? And what is actually happening, inside the three pounds of tissue between your ears, that determines whether you spend your seventies running your life or watching it happen to you?

This is the most technical chapter in the book. I'm not going to apologize for that. If you're going to commit to a system, you deserve to understand what the system is acting on. By the end of this chapter you should have the vocabulary to talk about your own brain the way you talk about your own balance sheet — with categories, with metrics, with a sense of which numbers move which other numbers. That clarity is the precondition for everything that follows.

## The Destination

Most wellness platforms optimize for the things you can see in the mirror. None of them are working backwards from the destination that actually matters. The body is the delivery system. The mind is what we're protecting.

I want to define cognitive healthspan precisely, because the word "longevity" has been so abused that it now means almost nothing. Cognitive healthspan is not the absence of dementia. It is not "anti-aging." It is not a brain-age score on an app. It is a measurable, lived state — the state of being fully yourself, in command of your own attention, memory, and judgment, for the entire arc of your life.

When I say measurable, I mean these five things:

**Clarity.** The speed at which you can move from a piece of information to a decision. The cleanness of your thinking when you're tired. Whether the second hour of a hard conversation is as sharp as the first.

**Recall.** The reliability of retrieval. Names, numbers, last week's conversation, the agenda item you were going to raise. Not just whether you remember — whether you remember on demand, without the embarrassed pause.

**Executive function.** The cost, in mental effort, of doing the things you used to do automatically. Planning a week. Sequencing a project. Switching context between three deals. The men who lose this first don't lose the capability — they lose the cheapness of it. Everything starts to feel expensive.

**Mood stability.** The flatness of the baseline. How quickly you recover from irritation. Whether minor frustration costs you the afternoon. Cognitive healthspan and emotional regulation are the same circuit; men routinely report "my temper has gotten shorter" years before they report "my memory has gotten worse."

**Identity continuity.** The hardest one to name and the most important one. The sense that the person waking up tomorrow is the same person who went to bed tonight. The continuity of your story to yourself. When that thread starts to fray, every other loss accelerates.

That is the destination. Not "live longer." Not "look younger." *Be yourself, in full, until the last day.* Best mind possible until your last day of life. That is what every protocol in the rest of this book is in service of.

## Brain Fog, Word Loss, Identity

Cognitive decline has a face years before it has a diagnosis. The face is familiar to every man reading this, even the ones who haven't admitted it out loud yet. Let me describe it, because the medical system isn't going to.

You walk into a room and forget the errand. Fine. Everyone does that. But it's started happening three times a week instead of once a month.

You're mid-sentence in a meeting and the word you want is gone. Not a rare word — a word you've used a thousand times. There's a pause. You substitute something weaker. The pause was a second, maybe two. Nobody noticed. *You* noticed.

You read a paragraph in a contract and have to read it again. Then a third time. The information is going in and not sticking. You blame the document. The document is fine.

The mental cost of a normal day has gone up. By six in the evening, you're not tired in your body — you're tired in your *head*. The Saturday morning that used to feel limitless now feels like recovery time. You start canceling things on Wednesday because you can already feel that you won't have the bandwidth by Friday.

Sleep gets ragged. You're up at three-fifteen, brain churning on nothing, and back asleep at five for ninety useless minutes before the alarm. You wake up not rested but pre-tired. The mood is shorter than it used to be. The patience with your wife, your kids, your team. You apologize more, or you stop apologizing because the resentment has gotten louder than the regret.

None of this gets you a diagnosis. None of it shows up on a standard physical. Your doctor will tell you it's stress, or aging, or that you should sleep more — without any plan for how. And you'll nod and leave, because what else is there to do.

What I'm describing is not a disease. It's the *prodrome*. It's the runway. It's the period — usually a decade, sometimes two — between the first quiet symptoms of cognitive aging and the moment something is wrong enough to be named. The medical system intervenes at the naming. The 4M system intervenes during the decade before, when the architecture is still plastic and the trajectory is still yours.

This is the part the reader needs to feel. The slide is already happening. You are already on the runway. The only question is what you do with the runway.

## The Mechanisms

Here is the vocabulary. Six mechanisms drive nearly all of the cognitive decline you'll experience between fifty and eighty. They are interconnected — none of them runs alone — but each one is a lever, and each one is modifiable. This is the diagnostic dashboard.

**Neuroinflammation.** The brain has its own immune cells, called microglia. In a healthy brain they prune synapses, clear debris, and stand down. In a chronically inflamed brain — driven by gut permeability, visceral fat, poor sleep, alcohol, infection load — microglia stay activated. Activated microglia don't just clean; they *attack*. They prune healthy connections and release inflammatory cytokines that damage neurons. Neuroinflammation is the central engine of cognitive aging. It's also the most upstream lever, because almost every other mechanism on this list either causes it or is amplified by it.

**Vascular contribution.** Your brain uses roughly twenty percent of your cardiac output for two percent of your body weight. It is a vascular organ first. The integrity of the small white-matter vessels — the deep penetrating arterioles that feed the connecting fibers between brain regions — determines how well the regions can talk to each other. When endothelial function declines (and it declines decades before cardiovascular symptoms appear), white-matter integrity drops. On an MRI this shows up as white-matter hyperintensities; in your life it shows up as slower processing speed, lost focus, and the executive-function tax I described above. Cerebral blood flow declines about half a percent per year through adulthood. That is not destiny — it is the rate in the average population. You can outperform the average dramatically.

**Glymphatic clearance.** The brain has a sewer system. It was only discovered in the last fifteen years. During deep, slow-wave sleep, cerebrospinal fluid washes through the brain along channels that follow the arteries, flushing out the metabolic waste of the day — including the amyloid-beta protein associated with Alzheimer's disease. Glymphatic clearance is a sleep-only function. If you don't get deep sleep, you don't take out the trash. Period. Years of poor sleep architecture is years of metabolic waste accumulating in tissue that was supposed to be cleaning itself every night. This is the fastest single lever for accelerating — or slowing — cognitive decline.

**Mitochondrial decline.** Neurons are extraordinary energy consumers. Every thought, every memory consolidation, every signal across a synapse is paid for in ATP. ATP is made in mitochondria, and mitochondrial function declines with age — fewer mitochondria per cell, lower efficiency per mitochondrion, more oxidative byproducts per unit of energy. This is the cellular substrate of "everything feels expensive." A brain running on degraded mitochondrial output cannot sustain the cognitive load it sustained at thirty-five, no matter how motivated the man is. Creatine, NAD precursors, exercise, and time-restricted eating are the levers here — and they work.

**Hormone signaling.** The brain is a hormonal target organ. Testosterone supports neural plasticity, motivation circuits, and dopaminergic tone. Thyroid hormone sets the metabolic floor of every cell, including neurons. Estrogen (yes, in men too) supports vascular health. Insulin signaling in the brain — sometimes called "type 3 diabetes" in the Alzheimer's literature — modulates memory formation directly in the hippocampus. The one-percent-per-year testosterone decline after thirty is not just about libido and muscle; it is a cognitive variable. Hormone optimization is not a vanity project; it is brain protection.

**Gut-brain axis.** I'm going to spend the whole next chapter on this, so I'll be brief here. Roughly ninety percent of your serotonin and fifty percent of your dopamine are made in your gut. The vagus nerve — the largest cranial nerve, the body's information superhighway between gut and brain — carries about ninety percent of its traffic *gut-to-brain*, not the other way around. A leaky, dysbiotic gut sends a constant inflammatory and neurochemical signal upstream. Brain fog usually starts in the gut and arrives in the head days later. If you are working on cognitive optimization without working on the gut, you are pulling on the rope from the wrong end.

Six mechanisms. Memorize them. The rest of this book is, in essence, a systematic plan for moving each of these levers in the right direction over the course of a year.

## Stress & Resilience

I need to address stress separately, because it is the mechanism most men minimize and most physicians underweight.

Chronic psychological stress is not a feeling. It is a hormonal cascade. Cortisol — released by the adrenal glands under HPA-axis drive — has a thousand jobs in acute defense and a small number of catastrophic jobs in chronic excess. Two of them are relevant here.

First: chronic cortisol elevation is directly neurotoxic to the hippocampus, the structure that builds and retrieves memory. Hippocampal volume in chronically stressed adults is *measurably smaller*. This is not a metaphor. Imaging studies show the shrinkage. Men in their fifties carrying ten years of unmanaged business-and-family stress are walking around with hippocampi the size of men a decade older. Memory complaints in this population aren't aging; they're stress damage.

Second: chronic cortisol degrades sleep architecture — the very deep-sleep stages your glymphatic system needs to clear the brain. So chronic stress takes a hit at the hippocampus directly, and a second hit at the system that was supposed to repair the first hit overnight. The cycle is closed and accelerating.

The reason I want you to internalize this: stress in our demographic is socially normalized as a kind of badge of effort. The guy putting in the hours. The guy carrying the family. The guy who doesn't complain. In my practice I've watched dozens of these men accept ten years of chronically elevated cortisol as the price of provision. It is not the price of provision. It is the price of the *unmanaged* version. Provision is not optional for the men I serve. Letting it eat your brain is.

Resilience is the word for what we're after, and resilience is not a personality trait. It is a measurable physiological state. The metric we use most is heart-rate variability, or HRV — the millisecond-to-millisecond variation in time between heartbeats, which reflects vagal tone and parasympathetic recovery capacity. High HRV means a nervous system that can ramp up fast and recover just as fast. Low HRV means a system stuck in sympathetic dominance. HRV is trainable. Box breathing — a four-four-four-four pattern, done daily — improves it in six weeks. Zone 2 cardio improves it. Cold exposure, sauna, sleep, and meaningful purpose improve it. Avoidance does not improve it. Bourbon does not improve it.

Build the resilience number. The hippocampus is downstream of it.

## The Peptide Layer

There is an advanced tier of intervention I'm going to introduce briefly here, because no honest treatment of cognitive healthspan is complete without it, and because it tends to be the thing my patients ask about first and understand least.

Peptides are short chains of amino acids — small, precise signaling molecules. The brain and body use them as switches. Pharmaceutical peptides are synthesized analogs of these signaling molecules, delivered at therapeutic doses, used to nudge specific systems in specific directions. They are not supplements. They are not gym-bro hacks. Used inside a real system, under medical oversight, they are the most precise tools available for re-tuning cognitive performance, recovery, and tissue repair.

Three nootropic peptides deserve naming here:

**Semax.** Originally developed in Russia for stroke recovery. Upregulates BDNF (brain-derived neurotrophic factor) and NGF (nerve growth factor) — the molecular fertilizers of neural plasticity. Patients on Semax protocols report improved focus, faster recall, and a kind of cognitive endurance that doesn't come from caffeine.

**Selank.** A close cousin of Semax with an anxiolytic profile. Reduces the cortical noise floor — the low-grade mental static of generalized anxiety — without the sedation, dependence, or cognitive cost of benzodiazepines. Useful for the man whose stress profile is keeping him from accessing his own intelligence.

**Cerebrolysin.** A neurotrophic peptide mixture used clinically in stroke and traumatic brain injury recovery, and increasingly studied for age-related cognitive decline. Administered in cycles. The data in mild cognitive impairment is meaningful.

A fourth peptide — **BPC-157** — bridges this chapter and the next. It is best known for tissue repair, but it acts centrally on neuroinflammation and on the gut-brain axis. It is the most-evidenced single molecule for closing a leaky gut, which is why our flagship Rx product, Biome NS Rx, is built around it. BPC-157 is a Mitigate molecule with a Mind effect. That is the kind of cross-pillar lever the 4M system exists to identify.

I want to be precise about positioning. The peptide layer is *not a substitute for the foundation*. Peptides amplify the fundamentals — sleep, training, gut integrity, hormone status — they do not replace them. Stacking peptides on a broken foundation is guesswork with real risk. Used correctly — lab-guided, prescribed, integrated into a 4M protocol — they are the upper tier of an integrated system. We'll meet them again in later chapters. For now, know that the layer exists, and know that it is available to you, through our contracted licensed telemedicine practice, when the foundation is in place.

## What Protecting Mind Actually Requires

Now zoom out. Here is what the next eleven chapters do, with the dashboard we just built.
...
Read that paragraph twice. It is the single thesis of this book, and it tells you exactly how the rest of the chapters connect to the chapter you just finished.

**Mitigate** is the next major section, and it is the largest. Mitigate is where we *stop hurting yourself first.* Every mechanism I named above — neuroinflammation, vascular degradation, glymphatic failure, mitochondrial decline, hormonal disruption, gut-brain dysfunction — has a list of inputs that are actively driving it the wrong way in your current life. Gut permeability. Sleep disruption. Environmental toxins. Hormone-disrupting habits. The erectile dysfunction canary. The substances you reach for at the end of the day. Mitigate removes those insults. Stop hurting yourself first. *Then* add what works.

**Muscle** is the engine. Resistance training is not vanity — it is the single most evidenced non-pharmaceutical intervention for cognitive longevity. Muscle is metabolic real estate; the more of it you have, the better your insulin signaling and your brain energy supply. Sarcopenia — the age-related loss of muscle — is a cognitive risk factor as much as it is a falls-and-frailty risk factor. The nutritional architecture, the GLP-1 conversation, the protein-first rule, the pain management that keeps you in the gym — all of it is here. Strong body, sharp mind. Resistance training is neuroprotection.

**Motivate** is the why and the how-you-keep-going. The most rigorous protocol in the world fails if compliance fails. Motivate is the layer of identity, purpose, accountability targets, daily rituals, knowledge access, and financial-stress management that makes the other three pillars sustainable for the rest of your life rather than for the next eight weeks. Without Motivate, men return to where they started. With it, the protocol becomes who they are.
...
The most underestimated driver of every single mechanism in this chapter — neuroinflammation, mood, dopamine, sleep, fog — sits below your diaphragm. The next chapter is about the gut, and why I run every cognitive protocol through it first.
...
If the gut is compromised, the report changes. Inflammation. Endotoxin. The wrong bacterial species amplifying the wrong signals. The vagus nerve dutifully carries it all upstream. And the brain, which has no nerve endings of its own and cannot tell you what is wrong, translates the signal into the only vocabulary it has: mood drops, motivational flatness, brain fog, word-finding lapses, the sense that you are watching your life through slightly fogged glass.
...
The brain is particularly vulnerable here. Airborne toxicants do not just hit your lungs. Ultrafine particles — particulate matter under 2.5 micrometers, what the literature calls PM2.5 — can access the brain directly through the olfactory nerve, bypassing the blood-brain barrier entirely. There is now a deep body of epidemiological research linking chronic PM2.5 exposure to accelerated cognitive decline, higher dementia incidence, and measurable changes in brain volume on imaging studies. This is no longer fringe. This is mainstream neurology.
...
The current FCC safety limits for RF exposure were set in 1996. They are based exclusively on thermal effects — whether the device heats tissue. They do not account for sub-thermal biological effects, because the regulatory framework predates the research showing those effects exist.
...
**Phone out of the bedroom at night, or on airplane mode.** This is the single highest-impact EMF intervention because it covers a third of your life at the lowest exposure cost. If you use your phone as an alarm, get a $15 alarm clock. They still work.
...
Begin with the end in mind. The end is the brain you want to have in your seventies and eighties. The environment you are sitting in right now is voting, every day, for or against that brain. Don't roll the dice.
...
Most men hear "low T" and imagine a number on a lab report. They imagine a binary — you have it, or you don't. That is not how the endocrine system works, and it is not how it fails.
...
This is why I refuse to treat low T as a single number. Total testosterone, free testosterone, estradiol, SHBG, TSH, AM cortisol, DHEA-S — these tell a story together that none of them tell alone. A "borderline normal" total T inside a high-estradiol, high-cortisol, low-SHBG environment is not borderline normal. It is a man whose entire hormonal architecture is sliding sideways while a single number reassures him that everything is fine.
...
The same endothelial dysfunction that has softened your erection is happening at the blood-brain barrier. The same insulin resistance, the same low-grade systemic inflammation, the same hormonal collapse, the same vascular stiffening — none of these processes target one organ. They are systemic. They affect every endothelial surface in your body. The brain has more endothelial surface area per gram than any other organ. It is, vascularly speaking, the most exposed tissue you have.
...
When erections start to fail, something specific happens to identity. Confidence erodes. Intimacy starts to feel like a test you might fail, so you avoid it. The woman who has loved you for thirty years senses the avoidance and reads it — wrongly — as distance. The distance compounds. You drink a little more in the evening to make the awkwardness go away. The alcohol degrades your sleep further and suppresses your testosterone further and damages your endothelium further, and the canary sings louder.
...
**Sleep under 7 hours, or undiagnosed sleep apnea.** Testosterone is produced during deep sleep. Sleep apnea fragments that sleep, drops nocturnal oxygen saturation, and is independently linked to ED. If you snore, wake unrefreshed, or your partner has stopped sleeping in the same room — that is part of the ED conversation, not a separate issue.
...
**Chronic unmanaged stress.** Sustained cortisol elevation suppresses the hypothalamic-pituitary-gonadal axis — the chain of command that tells your testicles to make testosterone in the first place. Erections, beyond the hardware, are a parasympathetic event. A nervous system stuck in sympathetic dominance, running on the fumes of a 60-hour week and a quarterly board meeting and the kind of low-grade dread successful men carry without naming, cannot deliver them reliably. The man who treats his calendar as untouchable while his canary stops singing is making a trade he didn't consciously agree to.
...
The chapter ends here, but I want to leave you with the frame again, because it matters. The ED is not your problem. The ED is the alarm. Most men will hear the alarm, reach for the pill, silence the alarm, and watch the fire keep burning underneath for another five years until something else — heart, brain, body composition, marriage — finally collapses. The men in my practice who get this right do the opposite. They treat the alarm as information. They run the labs. They build the protocol. They eliminate the insulting behaviors. They take their hormonal architecture as seriously at 55 as they took their first business plan at 35.
...
It is not a sobriety pitch. I am not asking you to put a chip on the mantel. I am not asking you to identify as anything. I am not asking you to swear off the next anniversary toast.
...
The free 4M Assessment at the back of this book has a rule built into it that I want to explain, because the rule is the thesis of this entire chapter.

The Assessment asks ten questions across the eight categories that drive cognitive decline. Most readers will score across several categories — some gut issues, some sleep issues, some hormone drift — and the algorithm ranks their top three so they know where to start. But there is one question, the "already diagnosed" question, that breaks the ranking. If your score on that question is three or higher — meaning you, or someone you are responsible for, already carries a cognitive diagnosis or has a hard family history paired with early symptoms — the algorithm doesn't rank it. It overrides. It moves to position number one. Automatically. No matter what else you scored.
...
Second, they differentiate appropriately. Once they arrive at the damaged tissue, they read the local environment and become the cell type that environment needs. In a region of demyelination, they shift toward oligodendrocyte lineage. In a region of neuronal stress, they shift toward neuronal lineage. In an area of vascular compromise, they support endothelial repair. They behave less like a transplant and more like a workforce that takes its job description from the foreman on site.
...
Every meal is a packet of information being delivered to your DNA, your microbiome, your immune system, your endocrine glands, and your brain. That packet is telling your body what to build, what to break down, what to inflame, what to quiet, what to store, and what to burn. The same number of calories from a grass-finished ribeye and a fast-food burger are not the same information. One signals: build lean tissue, hold blood sugar steady, feed the microbes that produce neurotransmitter precursors, lower inflammatory tone. The other signals: store fat, spike insulin, feed the wrong microbes, raise the inflammatory tone that crosses the blood-brain barrier and chips at cognition every single day.
...
When I say visceral fat is a neurotoxin, I am not being rhetorical. The cytokine load measurably degrades the blood-brain barrier, drives microglial activation, suppresses hippocampal neurogenesis, and accelerates the cellular cascades that drive Alzheimer's pathology. Studies in *Annals of Neurology* and the *Journal of Alzheimer's Disease* have repeatedly identified midlife visceral obesity as one of the most significant modifiable risk factors for dementia we have quantified.
...
# Part V — The Action Guide

> *Theory ends here. The protocol begins. Front of book sold you the why. Back of book runs the how.*

---

## How to Use This Action Guide

You've reached the back of the book. If you read straight through from Chapter 1, you have spent the last few hours understanding the system. Now you need to run it.

This section is built differently from the rest of the book. The chapters were prose. The Action Guide is structured for use. You are not meant to read it once and put it on a shelf. You are meant to print it, mark it up, and refer to it daily for the first month.

Here is what's in it:

- **§5.1 — Daily Check-Ins.** The four daily behaviors that produce 80% of the compounding. If you do nothing else from this book, do these.
- **§5.2 — The Stack.** Your daily supplement dosing card. What to take, when, with what, why.
- **§5.3 — The Weekly 4M Reflection.** One page per pillar. Fifteen minutes every Sunday evening. The single highest-leverage habit in the entire system.
- **§5.4 — The Adherence Scorecard.** The tear-out page. If this were a printed book, it would be perforated so you could pull it free and tape it to your bathroom mirror. Because the book is digital for now, you have two options: print this page, or photograph it for your phone lock-screen. Pick one before you finish reading this paragraph.
- **§5.5 — The 30-Day Recommit.** When you fall off — not *if*, *when* — this is the page you come back to. It is not a punishment. It is a procedure.

This guide mirrors the daily check-ins, weekly Zoom calls, and adherence scorecards that run inside the My4MLife app. The app does the tracking for you; this guide does the same work on paper, for the men who still think better with a pen in their hand.

The first 30 days are the hardest. They are also the most leveraged. By day 30, you will have built the architecture that makes compliance the path of least resistance for the next 30 years.

Begin with the end in mind. The end is your mind. Let's protect it.

---

## §5.1 — Daily Check-Ins

Four behaviors, every day. If you do nothing else from this book, do these four. They are not separate items on a to-do list. They are one architecture, and they hand off to each other.

### 1. Morning Sun + Walk (8-15 minutes)

**What:** Get outside, in direct sunlight, within the first 30-60 minutes of waking. Walk while you do it. Do not wear sunglasses.

**Why:** This is the master circadian signal. Morning light through the eyes resets the suprachiasmatic nucleus — the brain's clock — which then sets cortisol, melatonin, and the entire downstream hormone cascade for the day. Skip this and every other circadian intervention is fighting upstream.

**How:** Walk to the end of the block. Walk to the coffee shop. Walk around your yard. Eight minutes is the floor. Fifteen is better. Through a window does not count. Through sunglasses does not count.

**Track:** ☐ Done · ☐ Skipped · ☐ Partial (through window / sunglasses)
...
### 3. Eating Window Closes at 6 PM

**What:** No food after 6 PM. Water is fine. Herbal tea is fine. Food, no.

**Why:** Three reasons stacked. (a) Digestion competes with sleep architecture — late food fragments REM and reduces glymphatic clearance. (b) Eating in the evening signals "active" to the circadian system at the exact moment the body should be transitioning to rest. (c) Most men over 50 carry excess weight not because of total calories but because of evening grazing — closing the window at 6 closes a category of decision-making.

**How:** Eat dinner before 6. If you've got a business dinner that runs later, eat lighter and earlier in the day to compensate, and accept the bend. Don't let bend become break.

**Track:** ☐ Closed at 6 PM · ☐ Closed by 7 PM · ☐ Closed after 7 PM · ☐ Grazed past 9

---

### 4. Lights Out by 10:30 PM

**What:** Phone down, screens off, room dark, in bed by 10:30. Asleep by 11. Wake-up around 6 AM gives you a 7-hour sleep window.

**Why:** Glymphatic clearance — the brain's waste removal system — runs during deep NREM sleep, which clusters in the first half of the night. Going to bed at midnight cuts your glymphatic time in half regardless of how long you stay asleep. The men who sleep 8 hours but go to bed at 1 AM are not getting the brain-clearance benefit of 8 hours.

**How:** Backwards-plan. If lights out is 10:30, screens off is 9:30. If screens off is 9:30, last food was at 6. If last food was at 6, dinner started at 5:30. The chain runs upstream.

**Track:** ☐ Lights out by 10:30 · ☐ Lights out by 11:30 · ☐ Lights out after midnight

---

### The Daily Floor

These four are the daily floor. Sun, protein, eating-window, sleep. They are not negotiable, but they are also not heroic. None of them takes more than a few minutes of attention. They just take a few minutes *every day*.

Everything else in the protocol — the supplements, the lifts, the Mitigate work, the Motivate reflections — sits on top of these four. If the floor is unstable, the ceiling does not hold.

The four together take you about 25 minutes of intentional time on a normal day. That is the cost of admission.
...
| **Nootropic peptides** (Semax / Selank / Cerebrolysin) | Advanced cognitive layer. Coach-led. |
...
## §5.3 — The Weekly 4M Reflection

Fifteen minutes every Sunday evening. The single highest-leverage habit in the entire system. The men who do this for one year look back and don't recognize the man who started.

Pour something warm. Sit somewhere quiet. Take a pen. Run the four pages below in order.

### Page 1 — MIND (the destination)

Cognitive healthspan. What you're protecting.

> **This week, my Mind felt:**
> _(sharp / clear / foggy / scattered / sluggish — pick one or write your own)_
>
> **One specific moment of cognitive clarity I noticed:**
>
> **One specific moment of cognitive friction I noticed (word loss, mental fatigue, fog):**
>
> **What likely contributed?**
> _(sleep, alcohol, training, stress, food timing, supplement compliance)_
>
> **One adjustment for next week to support Mind:**

---

### Page 2 — MITIGATE (stop hurting yourself)

What you removed or reduced this week.

> **Insulting behaviors I successfully avoided this week:**
> _(alcohol nights, late-night eating, screens past 9, fluorescent lighting after dark, etc.)_
>
> **Insulting behaviors I did not avoid this week (no judgment, just data):**
>
...
### Page 3 — MUSCLE (the engine)

Strength, nutrition, fuel.

> **Training sessions this week:** __ (target: 2-3)
>
> **Protein-first breakfast hit days:** __ (target: 7)
>
> **Sunrise walk days:** __ (target: 7)
>
> **One PR or notable training moment:**
>
> **One nutritional win:**
>
> **One nutritional slip and the trigger behind it:**

---

### Page 4 — MOTIVATE (the why)

The recursive engine. The reason you do this.

> **Who am I doing this for? Name the face:**
>
> **One moment this week that reinforced my why:**
>
> **One moment this week I wanted to quit (everyone has them):**
>
> **What kept me showing up?**
>
> **One specific action my accountability person can hold me to next week:**

---

### Page 5 — The Single Adjustment

After completing the four pillar pages, write ONE sentence:

> **The single change I am committing to for next week:**

That's it. One. Not five. The men who change everything every week change nothing. The men who change one thing per week, every week for a year, are unrecognizable to themselves at the end of it.

Date the page. File it. Read it at the start of next Sunday's reflection.

This is how compounding actually works. Not dramatic resets. Honest weekly accounting + one small adjustment, fifty-two times in a row.

---

## §5.4 — The Adherence Scorecard

### THE TEAR-OUT PAGE

*If this were a printed book, this page would be perforated. You would tear it out, fold it once, and tape it inside your medicine cabinet door — eye level. Because this book is digital, you have two options. Pick one before you turn the page.*

> ☐ **Print this page** and tape it inside your medicine cabinet door.
>
> ☐ **Screenshot this page** and set it as your phone lock-screen for the next 30 days.

The point is not the paper. The point is you see it twice a day, when you brush your teeth. That is the moment the protocol either runs or doesn't.
...
**Weekly total:** ____ / 67 possible boxes

**My target this week:** ____ / 67

**My accountability target (the face I'm doing this for):** ________________________

---

> Your scorecard is not a moral document. It is a measurement. The men who run this protocol for life don't run it perfectly — they run it honestly. Honest tracking + one weekly adjustment beats heroic resets every time.
>
> When you fall below 80% in a week, do not try to make it up. Do not double-stack the next week. Turn to §5.5. Read it. Recommit.

---

*Dr. TJ Mundheim · My4MLife · Begin with the end in mind.*

---

## §5.5 — The 30-Day Recommit

You will fall off. Not *if*, *when*.

Three weeks in, life will intervene. Work travel. A family thing. A bad week of sleep that cascades into a bad week of food that cascades into a bad week of training. You will go three days without doing any of the four daily check-ins. You will skip the Sunday reflection. You will look at the scorecard on your bathroom mirror and feel something between guilt and resignation.

This is the moment that ends 90% of protocols.

It does not have to end this one.

What follows is a procedure. Not a pep talk. Not a re-motivation. A procedure for what to do when compliance breaks.

### Step 1 — Do Not Try to Make It Up

Do not double-stack supplements you missed. Do not skip meals to "balance" the bad week. Do not punish-lift Saturday morning because you missed Tuesday and Thursday. Do not write a long apologetic page in your weekly reflection.

The instinct to make up for lost time is what turns a one-week slip into a six-week absence. The men who try to recover heroically usually quit. The men who recover quietly usually stay.

### Step 2 — Pick One

Read your last Sunday reflection. Read the four daily check-ins (§5.1). Read the scorecard.

Pick ONE behavior. Just one. Not all four. Not even two.

The one you pick is whichever one is easiest *right now*. Not the one you "should" pick. Not the most important one. The one with the lowest activation energy this morning.

For most men returning from a slip, the answer is the morning sunlight walk. Eight minutes outside. That's it. That is the recommit move.

### Step 3 — Run That One for Three Days

Do the one behavior you picked. Just that one. Three days in a row. Today, tomorrow, the day after.

Do not touch the other three. Do not pretend you're "back on" the protocol. You're not. You're running one behavior for three days. That's the work.

### Step 4 — On Day Four, Add Back One More

After three consecutive days of the one behavior, add the second easiest. Run two behaviors for three more days.

### Step 5 — Continue Stacking Until You Are at Full Compliance

Three days at one. Three days at two. Three days at three. Three days at four. By day 13, you are running the full daily floor again. By day 14, the recommit is complete.

### Why This Works

Compliance is engineered, not willed.

When you try to "get back on track" by doing everything at once, you are asking the same willpower that just failed you to suddenly succeed. It won't. The architecture has to be rebuilt from one stable block at a time.

Three days of one behavior creates a foundation. Adding a second behavior on a stable foundation has roughly 4x the success rate of trying to start two behaviors at once.

This is the same principle that runs inside the My4MLife app. When the dashboard sees a slip, it does not ask the Protégé to do more — it asks for less, structured. The app is doing the same procedure this page is doing on paper.

### One More Rule

When you fall off — and you will — **do not stop showing up to the weekly Zoom.** Show up even when you have run zero behaviors that week. The cohort knows everyone falls off. The men who keep showing up at the Zoom during their slip weeks are the ones who recommit. The men who avoid the Zoom because they're embarrassed are the ones who disappear for six months.

Showing up at the Zoom IS a behavior. Add it to your three-day count.

### The Bigger Truth

This protocol is not the kind of thing you do for 30 days and finish.

It is the kind of thing you do for the rest of your life with periodic slips, periodic recommits, and gradual compounding that becomes visible in your face, your mind, your relationships, and your morning energy somewhere between months 6 and 18.

Begin with the end in mind. Re-begin every time you need to. The end stays the same.

---

*If you have read this page because you have fallen off, you have already done step zero — you opened the book. That's enough for now. Read §5.4 next. Pick one behavior. Start tonight.*
...
# Appendix A — The 10-Question Assessment

This is the same assessment that runs live at **my4mlife.com/assessment**. Ten questions, about five minutes, scored on a 0–5 scale per item. You can take it self-scored right here in the book — circle your number, do the math at the end — or you can run it online and get a live ranked result with your top three mitigating factors and the personalized solution paths attached.

The online version does a few things the page in front of you can't: it surfaces your top three categories in priority order, hands you the specific solution pages for each, and routes you into the Protégé app so the protocol starts the next morning. But the questions are the questions. If you answer them honestly on paper, you'll see your own pattern before the end of the chapter.
...
**Scoring:** 0 = No gut issues at all · 3 = Occasional bloating or food reactions a few times a month · 5 = Daily bloating, irregular stools, multiple food sensitivities, foggy after most meals

*The gut-brain axis sits underneath nearly everything else — fix this first and other categories often improve on their own.*

---

### 2 — Sleep / sleep optimization
...
**Scoring:** 0 = Sleep is solid — I fall asleep fast, stay asleep, and wake rested · 3 = Some nights great, some rough · 5 = Most nights are bad, I wake up tired, and timing is all over the place
...
**Scoring:** 0 = At my ideal weight, body composition feels right · 3 = About 10–20 lbs heavier than I should be · 5 = More than 30 lbs over target with visible belly fat
...
**Scoring:** 0 = Almost everything I eat is whole foods, mostly home-cooked · 3 = Mixed — some good days, some takeout / processed days · 5 = Fast food, packaged snacks, or convenience meals are my default

*Food quality is the daily input that drives microbiome diversity, blood sugar, and energy.*

---

### 5 — Erectile + sexual function
...
**Scoring:** 0 = Drive and function feel completely normal · 3 = Some noticeable off-weeks but not a steady pattern · 5 = Clear, sustained decline in drive, hardness, or morning erections
...
**Scoring:** 0 = I get morning sun daily, filtered air and water, low artificial light · 3 = Some exposure issues, partially managing · 5 = No morning sun, indoors all day under fluorescents/screens, tap water, no air filtration, constant EMF
...
**Scoring:** 0 = Energy, libido, mood, and recovery all feel optimal · 3 = Occasional symptoms, especially under stress · 5 = Multiple hormone-related symptoms most days affecting daily function
...
**Scoring:** 0 = I don't drink · 1 = Up to 2 drinks per week · 2 = 3–7 drinks per week, never more than 2 per sitting · 3 = More than 7 drinks per week, OR more than 2 per sitting regularly · 4 = Daily drinker (1–2 drinks per day) · 5 = Daily heavy drinker (3+ drinks per day)
...
No other category gets a bonus. Everything else is raw score.

**3. Rank and take the top three.** Add the bonus where it applies, sort from highest to lowest, and your top three are the categories to start with. That's your starting protocol. If two scores tie, the one with the bigger bonus wins; if they still tie, alphabetical decides it (the online scorer does this automatically).

If you want the ranked result, the solution pages, and the protocol queued up in the app instead of doing the arithmetic by hand, take it live at **my4mlife.com/assessment**. Five minutes. Free. That's the door in.
...
## Rx single-active add-ons (compounded via telemed partner)
...
- **GLP-1 protocols** — Semaglutide, tirzepatide, retatrutide. Brain-healthy weight loss via telemed partners. Used with a protein-first nutrition rule and resistance training to protect lean mass.

- **Peptide protocols** — Semax, Selank, Cerebrolysin, BPC-157, TB-500, ipamorelin. Coach-led, indication-matched, time-limited. Not a permanent stack — a precision tool.

- **ED Rx** — PDE5 inhibitors plus the supporting cardiovascular and hormonal protocols. Because ED is the canary, not the diagnosis — we treat the system, not just the symptom.
...
## Environmental hardware (affiliate — not branded My4MLife)

I don't make hardware. I do use it, and these are the units that pass the audit. The environment pillar is the most overlooked category in the assessment; these tools close the gap.

- **AirDoctor** — HEPA + VOC filtration. The air filter I run at home. Removes the particulate and volatile-organic load most filters skip.

- **AquaTru** — Reverse osmosis countertop unit with remineralization. Tap water is not neutral; this is the cheapest way to get it out of your life.

- **TrueDark** — Red-spectrum night lighting plus blue-blocker glasses. Protects melatonin onset after sundown. The simplest sleep-environment lever.

- **TriField** — EMF meter. You can't manage what you can't measure. One-time purchase; map your house once.
...
Every product on this list passes the No-Weak-Links audit. That means a full-ingredient review — every active, every excipient, every emulsifier, every oil. One off-message ingredient — a seed oil hiding in a "premium" softgel, a fake sweetener, a synthetic dye — disqualifies the entire SKU. No exceptions. That's why this list is shorter than most.

---

# Appendix C — Eliminate the Insulting Behavior Checklist

Mitigate works in one direction at a time. Add a protocol AND keep doing the thing that broke you, and you get no progress — you get a wash, an expensive wash. The order is the order: stop the insults first, then add what works. Print this page. Read down each pillar. Check the boxes that apply to you. If you check three or more in any category, that's your first thirty days of work — not a new supplement.

---

## Mitigate — the gut, the brain barrier, the environment

**Gut**

- ☐ Drinking more than 7 alcoholic beverages per week (LPS leakage, dysbiosis, leaky gut)
- ☐ Eating processed foods and seed oils as a daily baseline (microbiome stripping, chronic inflammation)
- ☐ Multiple antibiotic courses without targeted recovery afterward (scorched-earth microbiome, no replant)
- ☐ Routine NSAIDs, PPIs, or chronic acid-blockers (intestinal-lining damage, impaired digestion)
- ☐ Ignoring bloating, food sensitivities, or brain fog after meals (symptom denial — the gut is talking)
- ☐ Treating yogurt and kombucha as a "gut protocol" (random probiotics ≠ strain-specific repair)

**Sleep**

- ☐ Bright overhead light and screens past sundown (suppressed melatonin, delayed sleep onset)
- ☐ Alcohol within 3 hours of bed (fragmented REM, suppressed glymphatic clearance)
- ☐ Late caffeine — anything after 2 PM (half-life is 6 hours; you don't feel it but your brain does)
- ☐ Eating inside the 3-hour pre-sleep window (insulin and reflux degrade deep sleep)
- ☐ Bedroom warmer than 67°F or lit by any visible LED (impaired core-temperature drop)
- ☐ Treating "I'll sleep when I'm dead" as a personality (you'll get there faster than you planned)

**Environment**

- ☐ No morning sunlight in the first hour after waking (broken circadian anchor, downstream sleep collapse)
- ☐ Drinking unfiltered tap water by default (chlorine, fluoride, microplastics, pharmaceutical residue)
- ☐ No air filtration at home or office (VOC and particulate load you can't smell)
- ☐ Plastic food storage and bottled-water habit (endocrine-disrupting chemicals, daily dose)
- ☐ Phone on the nightstand, Wi-Fi router in the bedroom (EMF exposure during the only window the brain repairs)
- ☐ Indoors under fluorescents or LEDs all day, no outdoor breaks (light starvation, vitamin D collapse)

**Hormones**

- ☐ Never had a full hormone panel — guessing from symptoms (you can't fix what you haven't measured)
- ☐ Chronic under-sleeping while expecting normal testosterone (sleep is when T is made)
- ☐ Carrying visceral fat and assuming it's cosmetic (aromatase converts T to estradiol — fat is endocrine)
- ☐ Stress without recovery — no breath work, no walks, no decompression (chronic cortisol, suppressed gonadal axis)
- ☐ Plastic, parabens, conventional personal-care products (xenoestrogen load)
- ☐ Accepting the 1%/year T decline after 30 as "just aging" (it's optional, not destiny)

**Substance use**

- ☐ Daily alcohol of any volume (there is no protective dose — that study was wrong)
- ☐ Nicotine of any form (vape, pouch, gum) on a daily basis (vascular and dopamine damage)
- ☐ Recreational cannabis as a sleep aid (suppresses REM, builds tolerance, ages the hippocampus)
- ☐ OTC sleep meds nightly (anticholinergic load — Benadryl is on the dementia-risk list)

---

## Muscle — the engine, the metabolism
...
- ☐ Sub-1500 calorie diets that strip muscle along with fat (especially on GLP-1 without protein and lifting)

**Nutrition**

- ☐ Industrial seed oils — canola, soybean, corn, sunflower, safflower — in any "premium" food (oxidized PUFAs, mitochondrial damage)
- ☐ Eating breakfast carbs first thing — cereal, pastries, sweetened oats (blood-sugar rollercoaster, late-morning crash)
- ☐ Restaurant and takeout meals more than 3x/week (no control over oils, sodium, hidden sugar)
- ☐ "Low-fat" packaged products (sugar substitution, ultra-processed)
- ☐ Artificial sweeteners — sucralose, aspartame, acesulfame — daily (microbiome disruption, glucose dysregulation)
- ☐ Not knowing your protein target by bodyweight (under-eating protein for the goal you have)

---

## Mind — cognitive, peptides, the long signal

**Cognitive**

- ☐ Dismissing brain fog as "just getting older" (it's a signal, not a milestone)
- ☐ No daily learning or novel-skill input (the brain prunes what you don't use)
- ☐ Multitasking and constant context-switching all day (chronic attentional fragmentation, cortisol)
- ☐ Doom-scrolling 60+ minutes daily (dopamine baseline reset, attention erosion)
- ☐ Avoiding cardio and resistance work despite cognitive complaints (BDNF is generated by movement)
- ☐ Ignoring family history of cognitive decline (the window for prevention is now, not at diagnosis)

**Peptides**

- ☐ Buying research-grade peptides off the internet (no sourcing chain, no dose verification, no oversight)
- ☐ Stacking peptides without a coach or labs (peptides are tools, not multivitamins)
- ☐ Running peptides indefinitely with no cycling (receptor down-regulation, diminishing returns)
- ☐ Using peptides to compensate for sleep, diet, or stress you refuse to fix (you cannot out-peptide a bad protocol)

---

## Motivate — the foundation under the foundation

- ☐ No specific person you can name when asked "who are you doing this for?" (no accountability target = no follow-through)
- ☐ No written "why" — only a vague intention (untethered goals collapse under stress)
- ☐ No weekly review or cohort accountability (compliance decays in isolation)
- ☐ Treating the protocol as a phase, not an identity (phases end; identities don't)

---

If you checked more than five items total, you don't need a new supplement this week. You need a Mitigate week — stop the insults, hold the line, and let the system catch its breath. Then come back here, pick the next box, and close it.
...
**Dr. TJ Mundheim** is the founder of My4MLife. He built the program because he is living it — every protocol in this book is one he runs himself. The 4M framework is the system he wishes someone had handed him at 50. My4MLife is not a clinic; it is a system. He is here to teach it, refine it, and run it alongside the men who choose to plug in.
