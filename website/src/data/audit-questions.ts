...
export const AUDIT_QUESTIONS: AuditQuestion[] = [
  ...
  },
  {
    id: 'environment',
    n: '11',
    label: 'Environment (lack of sun at right times, blue light, EMF, air, water)',
    ...
    scoreGuide: '0 = Get morning + low-evening sun daily, clean air + water, low artificial light · 3 = Some exposure issues, managing partially · 5 = No morning sun, screens/fluorescents most of the day, tap water, no air filtration, constant EMF',
    categoryNote: 'Mitigate pillar — environmental load compounds inflammation over years. Lack of sun at the right times is the most overlooked driver.',
    priorityTier: false,
  ...
  },
  {
    ...
    scoreGuide: '0 = Strongly disagree — function is solid · 3 = Neutral / mixed · 5 = Strongly agree — clear, sustained decline. ED is a symptom, not a fault — it is an early-warning signal for hormones, cardiovascular, sleep, and cognitive trajectory.',
    categoryNote: 'Mitigate pillar — ED is the canary in the mine for hormonal, vascular, and cognitive drift.',
    priorityTier: true,
  ...
  },
  {
    ...
    scoreGuide: '0 = Strongly disagree — drive and morning function feel normal · 3 = Neutral / mixed — occasional off weeks · 5 = Strongly agree — clear, sustained decline in drive and morning erections. Morning erections are an objective marker of nocturnal testosterone release and vascular health — when they fade, the upstream system is asking for attention.',
    categoryNote: 'Mitigate pillar — paired with ED, this captures the underlying hormonal-vascular signal earlier and more sensitively than ED alone.',
    priorityTier: true,
    solutionSlug: 'erectile-dysfunction',
  },
  {
