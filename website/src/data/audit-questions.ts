...
export const AUDIT_QUESTIONS: AuditQuestion[] = [
  ...
  },
  {
    ...
    scoreGuide: '0 = >15 min direct sun daily AND tested optimal in the past year · 3 = Inconsistent sun and no recent test · 5 = Indoor work, no recent lab test, no supplementation',
    categoryNote: 'Mitigate pillar — vitamin D deficiency is the silent epidemic in men 35-60.',
    priorityTier: false,
    solutionSlug: 'vitamin-d',
  },
  {
    id: 'environment',
    n: '11',
