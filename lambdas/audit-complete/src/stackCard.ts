...
// /stack page; the email only ever links there.
...
<p style="margin:0"><a href="${STACK_URL}" style="background:#4a6fa5;color:#fff;padding:12px 24px;border-radius:999px;text-decoration:none;font-weight:700;display:inline-block;font-size:14px">See Your Stack &rarr;</a></p>
</div>`;
}
