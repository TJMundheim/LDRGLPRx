...
- **No git worktrees.** Never run `git worktree add` or operate from a worktree under `.claude/worktrees/` or anywhere else. All work happens in the primary checkout at `/Users/thomasmundheim/Desktop/Development/LDRGLPRx`.
