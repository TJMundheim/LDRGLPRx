...
const TIERS: MembershipTier[] = [
  {
    ...
    description: 'Foundation delivers the core clinical starting protocol: comprehensive labs, cognitive baseline, an initial clinician visit, and your first Biome-AF cycle — all included in the onboarding fee.',
    idealFor: [
...
const COHORT_TIERS: MembershipTier[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'All 4 proprietary formulas prescribed: Biome-AF, SleepRestore, ArmorVita, NeuroBridge',
  ...
  pillars: [
    {
      ...
      objectives: [
        ...
        'Gut-brain axis repair (Biome-AF)',
