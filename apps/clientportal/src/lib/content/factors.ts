...
export const factors: Factor[] = [
  { n:'00', name:'Allergies & immune reactivity', tag:'IMMUNE', tc:'#7a3a6b' /* darkened from #9B4D8A for AA contrast on white */, pillarId:'mitigate',
    ...
    imm:['Request an IgE and IgG food sensitivity panel from your healthcare provider',
  ...
  { n:'01', name:'Mental health & mental wellness', tag:'Connected Mind', tc:'var(--mc-info)', pillarId:'motivate',
  ...
  { n:'02', name:'Gut microbiome health', tag:null, pillarId:'mitigate',
    ...
    adv:['Consider Viome or Genova GI Effects comprehensive gut testing',
         'Rule out SIBO or leaky gut with your healthcare provider if issues are persistent',
  ...
  { n:'03', name:'Poor dental health & oral microbiome', tag:'Oral · Brain · Heart', tc:'var(--mc-gold)', pillarId:'mitigate',
  ...
  { n:'05', name:'Alcohol consumption', tag:null, pillarId:'mitigate',
    ...
    adv:['Consider a 30-day alcohol-free challenge — Dry January or Sober October as entry points',
         ...
         'If drinking feels uncontrollable, speak with your healthcare provider — this is medical not moral'],
  ...
  { n:'07', name:'Poor nutrition quality', tag:'Keto-Paleo', tc:'var(--mc-good)', pillarId:'mind',
    sub:'Ultra-processed food, poor animal food quality, or chronic under-eating protein',
    imm:['Set your eating window now: default is 9am–6pm — work toward moving to 5pm, then experiment with 4–5pm to further regulate cortisol before sleep',
         'Until you reach ideal body weight, low body fat, and low visceral fat: train fasted in the morning (water or black coffee only). Fasted morning walking is a great accelerator. Break the fast after your workout with 30–40g of lean protein — if your workout ends around 10am, eat after that.',
    ...
    res:[{n:'ButcherBox — grass-fed beef & wild salmon',u:'https://butcherbox.com'},
         ...
         {n:'Thrive Market — pantry staples & keto/paleo essentials',u:'https://thrivemarket.com'}] },
  { n:'08', name:'Physical inactivity & injuries', tag:'KOT', tc:'var(--mc-crit)', pillarId:'muscle',
  ...
  { n:'08b', name:'Injury history & joint health', tag:'JOINTS', tc:'var(--mc-crit)', pillarId:'muscle',
  ...
  { n:'11', name:'Social isolation & lack of purpose', tag:null, pillarId:'motivate',
    ...
    imm:['Reach out to one person you have been meaning to connect with this week — today',
         ...
         'Introduce yourself actively in the My4MLife App community during your first week.'],
    tools:['Loneliness raises dementia risk as much as smoking 15 cigarettes per day — peer-reviewed',
           ...
           'The My4MLife program is itself a direct intervention for this risk factor — use it actively, not passively'],
  ...
  { n:'12', name:'Cognitive disengagement', tag:null, pillarId:'mind',
    ...
    imm:['Commit to 30 minutes of uninterrupted reading today — no phone, no TV, no interruptions',
         'Read at least 10 pages of Begin with the End in Mind today — and every day this month',
    ...
    tools:['Neural circuits that are not regularly activated begin to prune — use it or lose it is literal biology',
           'Reading a physical book activates deep-focus neural networks that scrolling and video never engage',
    ...
    adv:['Take a language class, chess course, or music lesson — novelty drives neuroplastic change',
         ...
         'Daily long-form reading plus active learning (a language, instrument, or course) is the most evidence-backed cognitive protocol available'],
    res:[{n:'Duolingo',u:'https://duolingo.com'},
