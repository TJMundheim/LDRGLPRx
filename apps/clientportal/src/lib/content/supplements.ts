...
export const supplements: Supplement[] = [
  ...
  {n:'OmegaCN Prime', d:'2 softgels (EPA 1200 + DHA 800, IFOS 5-star + Kaneka QH® ubiquinol CoQ10 200mg)', t:'With dinner', w:'Cardio-neuro foundation — omega-3 + mitochondrial CoQ10 in one stack. Until it ships, the bridge is two products with dinner: Nordic Naturals Ultimate Omega 2X (2 softgels) + Doctor\'s Best Kaneka Ubiquinol 200 mg (1 softgel). Links on my4mlife.com/solutions/nutritional-supplements.', week2:true, special:true},
