...
export const months: MonthDefinition[] = [
  {
    ...
    bonusModules: [
      {
        atWeek: 4,
        name: 'Genesis RPA Introduction',
        slug: 'genesis-rpa',
        description:
          'End-of-month introduction to the Genesis Regenerative Protocol Add-on. Candidacy review begins here for members who qualify based on their Month 1 labs and compliance score.',
      },
    ],
    graduationCriteria: [
  ...
  },
  {
    ...
    description:
      'Month 2 increases training intensity and extends the fasting window to 16:8. Nutrition deepens with liver introduction and protein precision. Genesis RPA candidacy review takes place mid-month for qualifying Tier 3 members.',
