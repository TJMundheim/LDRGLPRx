...
export const products: Product[] = [
...

  {
    ...
    shortName: 'AV',
    category: 'rx',
    tagline: 'Fat-soluble defense — physician-prescribed and precision-dosed.',
    description:
    ...
    longDescription:
      'ArmorVita combines the fat-soluble micronutrients most commonly deficient in the 35-60 population into a single physician-prescribed capsule with an MCT base for maximum absorption. Boron at the clinical dose of 6mg has NIH-published data showing +28% free testosterone in 7 days. Astaxanthin at 8mg provides potent mitochondrial and cardiovascular antioxidant activity. K2 with both MK7 and MK4 isoforms ensures calcium is directed to bone rather than arterial walls.',
